...
export default function Sidenav({ screenWidth, toggleSidebar }: SidenavProps) {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`${!isCollapsed ? 'w-0 md:w-20' : 'w-full sm:w-60'} bg-[#e63946] transition-all duration-500 ease-in-out fixed z-10 top-0 left-0 h-screen shadow-right`}
    >
